...
#include "AI/AnimateForTask.h"
#include "AI/WaitAnimationTask.h"
#include "AI/WaitDialogTask.h"
#include "AI/WaitTalkingTask.h"
#include "AI/RunDialogTask.h"
#include "AI/FadeInTask.h"
#include "AI/FadeOffTask.h"
#include "AI/PushCommandTask.h"
...
{
    s32 argsCount = lua_gettop(L);
    if (argsCount < 4)
    {
        LuaNote(PR_ERROR, "defineWeapon(): expected at least 4 arguments");
        return -1;
    }
